...
class JsonParser:
    ...
    def parse_results(self):
        ...
        for suite in json_data["Suites"]:
            ...
            suite_jira_id = model_support.convert_to_list(
                suite.get("Suite_Jira_ID", "")
            )
            suite_label_id = model_support.convert_to_list(
                suite.get("Suite_Label_ID", "")
            )
            suite_tag_info = model_support.convert_to_list(
                suite.get("Suite_Tag_Info", "")
            )
    ...
    def _read_attachments(self, attachment_list):
        ...
        for attachment_dict in attachment_list:
            ...
            attachment_objects.append(
                Attachment(attachment_dict["path"], attachment_time)
            )
    ...
    def _read_steps_information(self, steps):
        ...
        for step in steps:
            ...
            step_actual = model_support.convert_list_to_line_separated(
                step.get("Actual", "")
            )
