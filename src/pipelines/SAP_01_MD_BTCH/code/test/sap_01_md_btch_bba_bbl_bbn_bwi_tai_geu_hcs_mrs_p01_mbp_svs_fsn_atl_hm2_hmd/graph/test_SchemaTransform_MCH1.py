...
from sap_01_md_btch_bba_bbl_bbn_bwi_tai_geu_hcs_mrs_p01_mbp_svs_fsn_atl_hm2_hmd.graph.SchemaTransform_MCH1 import *
...
class SchemaTransform_MCH1Test(BaseTestCase):
    ...
    def test_pk(self):
        dfIn0 = createDfFromResourceFiles(
            ...
            'test/resources/data/sap_01_md_btch_bba_bbl_bbn_bwi_tai_geu_hcs_mrs_p01_mbp_svs_fsn_atl_hm2_hmd/graph/SchemaTransform_MCH1/in0/data/test_pk.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            ...
            'test/resources/data/sap_01_md_btch_bba_bbl_bbn_bwi_tai_geu_hcs_mrs_p01_mbp_svs_fsn_atl_hm2_hmd/graph/SchemaTransform_MCH1/out/data/test_pk.json',
            'out'
        )
    ...
    def test_timestamp(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_btch_bba_bbl_bbn_bwi_tai_geu_hcs_mrs_p01_mbp_svs_fsn_atl_hm2_hmd/graph/SchemaTransform_MCH1/in0/schema.json',
            'test/resources/data/sap_01_md_btch_bba_bbl_bbn_bwi_tai_geu_hcs_mrs_p01_mbp_svs_fsn_atl_hm2_hmd/graph/SchemaTransform_MCH1/in0/data/test_timestamp.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_btch_bba_bbl_bbn_bwi_tai_geu_hcs_mrs_p01_mbp_svs_fsn_atl_hm2_hmd/graph/SchemaTransform_MCH1/out/schema.json',
            'test/resources/data/sap_01_md_btch_bba_bbl_bbn_bwi_tai_geu_hcs_mrs_p01_mbp_svs_fsn_atl_hm2_hmd/graph/SchemaTransform_MCH1/out/data/test_timestamp.json',
            'out'
        )
        dfOutComputed = SchemaTransform_MCH1(self.spark, dfIn0)
