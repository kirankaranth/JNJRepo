...
from sap_md_matl_uom_mbp_svs_p01_hcs_hmd.graph import *
...
def pipeline(spark: SparkSession) -> None:
    ...
    df_DS_SAP_03_T006T = DS_SAP_03_T006T(spark)
    df_DS_SAP_03_T006T = collectMetrics(
        spark, 
        df_DS_SAP_03_T006T, 
        "graph", 
        "zH2FOw13D_c09uEb9gPCB$$1ohqluAfb13FtQfHqvweG", 
        "CnkOUsep01dpmV2Fb3EFW$$uEsmmtkDNZIN1uJ5s-xgs"
    )
    df_MANDT_03 = MANDT_03(spark, df_DS_SAP_03_T006T)
    Lookup_05_T006T(spark, df_MANDT_03)
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/MD_SAP_MATL_UOM_MBP_SVS_P01_HCS_HMD")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/MD_SAP_MATL_UOM_MBP_SVS_P01_HCS_HMD")
    pipeline(spark)
