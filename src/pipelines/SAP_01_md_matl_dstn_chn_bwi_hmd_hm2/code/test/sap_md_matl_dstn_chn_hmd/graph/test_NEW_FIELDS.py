...
from sap_md_matl_dstn_chn_hmd.graph.NEW_FIELDS import *
...
class NEW_FIELDSTest(BaseTestCase):
    ...
    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/NEW_FIELDS/in0/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/NEW_FIELDS/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/NEW_FIELDS/out/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/NEW_FIELDS/out/data/test_unit_test_.json',
            'out'
        )
        dfOutComputed = NEW_FIELDS(self.spark, dfIn0)
        assertDFEquals(
            dfOut.select("_pk_", "_deleted_", "SRC_SYS_CD", "MATL_NUM", "SL_ORG_NUM", "DSTR_CHNL_CD", "_pk_md5_"),
