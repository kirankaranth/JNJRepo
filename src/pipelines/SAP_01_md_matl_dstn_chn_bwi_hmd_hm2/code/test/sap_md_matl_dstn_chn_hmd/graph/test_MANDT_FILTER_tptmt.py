...
from sap_md_matl_dstn_chn_hmd.graph.MANDT_FILTER_tptmt import *
from sap_md_matl_dstn_chn_hmd.config.ConfigStore import *


class MANDT_FILTER_tptmtTest(BaseTestCase):

    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tptmt/in0/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tptmt/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tptmt/out/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tptmt/out/data/test_unit_test_.json',
            'out'
        )
        dfOutComputed = MANDT_FILTER_tptmt(self.spark, dfIn0)
