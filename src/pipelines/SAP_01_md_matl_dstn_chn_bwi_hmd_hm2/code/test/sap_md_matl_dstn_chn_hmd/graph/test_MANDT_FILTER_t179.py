...
from sap_md_matl_dstn_chn_hmd.graph.MANDT_FILTER_t179 import *
from sap_md_matl_dstn_chn_hmd.config.ConfigStore import *


class MANDT_FILTER_t179Test(BaseTestCase):

    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_t179/in0/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_t179/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_t179/out/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_t179/out/data/test_unit_test_.json',
            'out'
        )
        dfOutComputed = MANDT_FILTER_t179(self.spark, dfIn0)
        assertDFEquals(
            dfOut.select("PRODH", "STUFE"),
            dfOutComputed.select("PRODH", "STUFE"),
