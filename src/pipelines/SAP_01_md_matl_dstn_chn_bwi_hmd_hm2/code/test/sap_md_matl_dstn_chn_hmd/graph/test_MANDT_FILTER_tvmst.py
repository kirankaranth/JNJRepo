...
from sap_md_matl_dstn_chn_hmd.graph.MANDT_FILTER_tvmst import *
from sap_md_matl_dstn_chn_hmd.config.ConfigStore import *


class MANDT_FILTER_tvmstTest(BaseTestCase):

    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tvmst/in0/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tvmst/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tvmst/out/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tvmst/out/data/test_unit_test_.json',
            'out'
        )
        dfOutComputed = MANDT_FILTER_tvmst(self.spark, dfIn0)
        assertDFEquals(
            dfOut.select("VMSTA", "VMSTB"),
            dfOutComputed.select("VMSTA", "VMSTB"),
