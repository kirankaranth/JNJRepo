...
from sap_md_matl_dstn_chn_hmd.graph.MANDT_FILTER_tvms import *
from sap_md_matl_dstn_chn_hmd.config.ConfigStore import *


class MANDT_FILTER_tvmsTest(BaseTestCase):

    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tvms/in0/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tvms/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tvms/out/schema.json',
            'test/resources/data/sap_md_matl_dstn_chn_hmd/graph/MANDT_FILTER_tvms/out/data/test_unit_test_.json',
            'out'
        )
        dfOutComputed = MANDT_FILTER_tvms(self.spark, dfIn0)
        assertDFEquals(
            dfOut.select(
              "VMSTA",
              "SPVBA",
