...
from PPLN_MES_MD_SPEC_5.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/PPLN_MES_MD_SPEC_5")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/PPLN_MES_MD_SPEC_5")
    pipeline(spark)
