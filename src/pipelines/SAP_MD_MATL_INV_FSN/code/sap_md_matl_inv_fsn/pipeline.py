...
from sap_md_matl_inv_fsn.graph import *
...
def pipeline(spark: SparkSession) -> None:
    ...
    df_DS_SAP_00000004_MSLB = collectMetrics(
        spark, 
        df_DS_SAP_00000004_MSLB, 
        "graph", 
        "fLlV-52sKi6etwKAGsJgl$$SGNs_yO7Dv1C-Ewk6not5", 
        "jjxxhBalegRJK59_faiLl$$ueW88r3wUBTQLh6Ngrevz"
    )
    ...
    df_SchemaTransform_3_MKOL = SchemaTransform_3_MKOL(spark, df_Select_MKOL)
    ...
    df_SchemaTransform_5_MSSL = SchemaTransform_5_MSSL(spark, df_SELECT_MSSL)
    df_SET_FIELD_ORDER_5 = SET_FIELD_ORDER_5(spark, df_SchemaTransform_5_MSSL)
    df_SELECT_MSLB = SELECT_MSLB(spark, df_MANDT_4)
    df_SchemaTransform_4_MSLB = SchemaTransform_4_MSLB(spark, df_SELECT_MSLB)
