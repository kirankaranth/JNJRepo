...
from jde_md_matl_loc_jsw.udfs.UDFs import *
from prophecy.utils import *
from jde_md_matl_loc_jsw.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/JDE_MD_MATL_LOC_JSW")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/JDE_MD_MATL_LOC_JSW")
    pipeline(spark)
