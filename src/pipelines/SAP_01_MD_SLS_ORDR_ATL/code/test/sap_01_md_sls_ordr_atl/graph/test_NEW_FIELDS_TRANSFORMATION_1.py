...
from sap_01_md_sls_ordr_atl.graph.NEW_FIELDS_TRANSFORMATION_1 import *
...
class NEW_FIELDS_TRANSFORMATION_1Test(BaseTestCase):
    ...
    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/NEW_FIELDS_TRANSFORMATION_1/in0/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/NEW_FIELDS_TRANSFORMATION_1/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/NEW_FIELDS_TRANSFORMATION_1/out/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/NEW_FIELDS_TRANSFORMATION_1/out/data/test_unit_test_.json',
            'out'
        )
    ...
    def setUp(self):
        ...
        dfgraph_LU_SAP_TVTWT = createDfFromResourceFiles(
            ...
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVTWT/data.json',
            "in0"
        )
        ...
        dfgraph_LU_SAP_TVFST = createDfFromResourceFiles(
            ...
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVFST/data.json',
            "in0"
        )
        ...
        dfgraph_LU_SAP_TVAKT = createDfFromResourceFiles(
            ...
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVAKT/data.json',
            "in0"
        )
        from sap_01_md_sls_ordr_atl.graph.LU_SAP_TVAKT import LU_SAP_TVAKT
        LU_SAP_TVAKT(self.spark, dfgraph_LU_SAP_TVAKT)
        dfgraph_LU_SAP_TVKOT = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVKOT/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVKOT/data.json',
            "in0"
        )
        from sap_01_md_sls_ordr_atl.graph.LU_SAP_TVKOT import LU_SAP_TVKOT
        LU_SAP_TVKOT(self.spark, dfgraph_LU_SAP_TVKOT)
        dfgraph_LU_SAP_TVAU = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVAU/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVAU/data.json',
            "in0"
        )
        from sap_01_md_sls_ordr_atl.graph.LU_SAP_TVAU import LU_SAP_TVAU
        LU_SAP_TVAU(self.spark, dfgraph_LU_SAP_TVAU)
        dfgraph_LU_SAP_T176T = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_T176T/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_T176T/data.json',
            "in0"
        )
        ...
        dfgraph_LU_SAP_TVLST = createDfFromResourceFiles(
            ...
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVLST/data.json',
            "in0"
        )
        from sap_01_md_sls_ordr_atl.graph.LU_SAP_TVLST import LU_SAP_TVLST
        LU_SAP_TVLST(self.spark, dfgraph_LU_SAP_TVLST)
        dfgraph_LU_SAP_TSPAT = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TSPAT/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TSPAT/data.json',
            "in0"
        )
        from sap_01_md_sls_ordr_atl.graph.LU_SAP_TSPAT import LU_SAP_TSPAT
        LU_SAP_TSPAT(self.spark, dfgraph_LU_SAP_TSPAT)
        dfgraph_LU_SAP_TVAUT = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVAUT/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/LU_SAP_TVAUT/data.json',
            "in0"
        )
        from sap_01_md_sls_ordr_atl.graph.LU_SAP_TVAUT import LU_SAP_TVAUT
