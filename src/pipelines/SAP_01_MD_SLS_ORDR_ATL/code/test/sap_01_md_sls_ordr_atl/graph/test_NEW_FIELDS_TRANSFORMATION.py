...
from sap_01_md_sls_ordr_atl.graph.NEW_FIELDS_TRANSFORMATION import *
...
class NEW_FIELDS_TRANSFORMATIONTest(BaseTestCase):
    ...
    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/NEW_FIELDS_TRANSFORMATION/in0/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/NEW_FIELDS_TRANSFORMATION/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/NEW_FIELDS_TRANSFORMATION/out/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_atl/graph/NEW_FIELDS_TRANSFORMATION/out/data/test_unit_test_.json',
            'out'
        )
