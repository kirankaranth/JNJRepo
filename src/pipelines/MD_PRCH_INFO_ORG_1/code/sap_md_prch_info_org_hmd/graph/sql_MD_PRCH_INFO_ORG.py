...
CAST(EINE.minbm AS DECIMAL(18,4))  AS  MIN_PO_QTY,
CAST(EINE.norbm AS DECIMAL(18,4))  AS  STD_PO_QTY,
TRIM(EINE.bonus)  AS  VOL_REBT_IND,
TRIM(EINE.mgbon)  AS  QTY_REBT,
CAST(EINE.aplfz AS DECIMAL(18,4)) AS  PLAN_DELV_DAYS,
...
CAST(EINE.bstma AS DECIMAL(18,4))  AS  MAX_PO_QTY,
