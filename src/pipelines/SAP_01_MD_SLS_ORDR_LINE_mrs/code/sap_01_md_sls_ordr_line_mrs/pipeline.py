...
from sap_01_md_sls_ordr_line_mrs.graph import *
...
def pipeline(spark: SparkSession) -> None:
    ...
    df_SAP_TVM4T = collectMetrics(
        ...
        df_SAP_TVM4T, 
        "graph", 
        "ziK7A3YYjTxoOybvnW8Ss$$JxrXxCB_LGee4Mp6PCkBG", 
        "kr_lyIkWsTBBb7KxWxxew$$bU7pMKgyXxuuKNAK1oplc"
    )
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/SAP_01_MD_SLS_ORDR_LINE_mrs")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/SAP_01_MD_SLS_ORDR_LINE_mrs")
    pipeline(spark)
