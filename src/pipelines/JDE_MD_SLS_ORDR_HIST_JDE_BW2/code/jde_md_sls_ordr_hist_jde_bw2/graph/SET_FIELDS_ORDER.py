...
def SET_FIELDS_ORDER(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        col("PTNR_ADDR_NUM"), 
        col("SHIP_TO_ATTN"), 
        col("PTNR_CNTCT_LINE_NUM_ID"), 
        col("CUST_CNTCT_LINE_NUM_ID"), 
        col("SHIP_TO_CUST_CNTCT_LINE_NUM_ID"), 
        col("OPP_NUM"), 
        col("ORG_STRC_TYPE"), 
        col("UNIQ_KEY_ID"), 
        col("CATLG_NM"), 
        ...
        col("CUST_MSTR_CO"), 
        col("KIT_ID"), 
        col("ACUM_AMT_INVC_DOM"), 
        col("ACUM_AMT_INVC_FRGN"), 
        col("KIT_CMPNT_DIRTY_FL"), 
        col("OC_IN_TRNST_FL"), 
        col("OC_KANBAN_CARD_NO"), 
        col("PRDTN_NUM"), 
        col("PRDTN_NUM_SHRT"), 
        col("DAI_ETL_ID"), 
        col("DAI_CRT_DTTM"), 
