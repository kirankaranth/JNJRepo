...
from sap_md_sls_ordr_sched_line_delv_mbp.config.ConfigStore import *
from sap_md_sls_ordr_sched_line_delv_mbp.udfs.UDFs import *
...
AND VBAK._deleted_ = 'F' AND VBAK.MANDT = \"600\"
LEFT JOIN {Config.sourceDatabase}.TVLST TVLST
ON VBEP.LIFSP = TVLST.LIFSP
AND TVLST._deleted_ = 'F' AND TVLST.MANDT = \"600\" AND TVLST.SPRAS = 'E'
where VBEP._deleted_ = 'F' AND VBEP.MANDT =\"600\"  
