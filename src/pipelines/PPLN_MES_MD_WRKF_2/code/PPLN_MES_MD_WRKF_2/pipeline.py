...
from PPLN_MES_MD_WRKF_2.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/PPLN_MES_MD_WRKF_2")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/PPLN_MES_MD_WRKF_2")
    pipeline(spark)
