...
from sap_md_co_cd_hmd.graph.NEW_FIELDS_TRANSFORMATION import *
...
class NEW_FIELDS_TRANSFORMATIONTest(BaseTestCase):
    ...
    def test_trim(self):
        dfIn0 = createDfFromResourceFiles(
            ...
            'test/resources/data/sap_md_co_cd_hmd/graph/NEW_FIELDS_TRANSFORMATION/in0/data/test_trim.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_co_cd_hmd/graph/NEW_FIELDS_TRANSFORMATION/out/schema.json',
            'test/resources/data/sap_md_co_cd_hmd/graph/NEW_FIELDS_TRANSFORMATION/out/data/test_trim.json',
            'out'
        )
        dfOutComputed = NEW_FIELDS_TRANSFORMATION(self.spark, dfIn0)
        assertDFEquals(
            dfOut.select("RCNL_ACCT_GENL_LDGR", "TERM_PMT_KEY"),
            dfOutComputed.select("RCNL_ACCT_GENL_LDGR", "TERM_PMT_KEY"),
    ...
    def test_decimal(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_co_cd_hmd/graph/NEW_FIELDS_TRANSFORMATION/in0/schema.json',
            'test/resources/data/sap_md_co_cd_hmd/graph/NEW_FIELDS_TRANSFORMATION/in0/data/test_decimal.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_co_cd_hmd/graph/NEW_FIELDS_TRANSFORMATION/out/schema.json',
            'test/resources/data/sap_md_co_cd_hmd/graph/NEW_FIELDS_TRANSFORMATION/out/data/test_decimal.json',
            'out'
        )
        dfOutComputed = NEW_FIELDS_TRANSFORMATION(self.spark, dfIn0)
        assertDFEquals(
