...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/JDE_01_F0401_JET_JES_DJD")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/JDE_01_F0401_JET_JES_DJD")
    pipeline(spark)
