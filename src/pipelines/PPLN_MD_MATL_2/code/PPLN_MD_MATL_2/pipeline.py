...
from PPLN_MD_MATL_2.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/PPLN_MD_MATL_2")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/PPLN_MD_MATL_2")
    pipeline(spark)
