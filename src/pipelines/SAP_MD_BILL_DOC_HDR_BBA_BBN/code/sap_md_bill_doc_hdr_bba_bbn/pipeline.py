...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/SAP_MD_BILL_DOC_HDR_BBA_BBN")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/SAP_MD_BILL_DOC_HDR_BBA_BBN")
    pipeline(spark)
