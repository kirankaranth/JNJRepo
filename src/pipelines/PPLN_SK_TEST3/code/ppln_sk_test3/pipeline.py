...
from ppln_sk_test3.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/PPLN_SK_TEST3")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/PPLN_SK_TEST3")
    pipeline(spark)
