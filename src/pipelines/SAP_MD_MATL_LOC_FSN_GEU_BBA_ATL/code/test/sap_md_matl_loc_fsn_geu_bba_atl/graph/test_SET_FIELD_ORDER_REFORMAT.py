...
from sap_md_matl_loc_fsn_geu_bba_atl.graph.SET_FIELD_ORDER_REFORMAT import *
...
class SET_FIELD_ORDER_REFORMATTest(BaseTestCase):
    ...
    def test_unit_test_0(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_loc_fsn_geu_bba_atl/graph/SET_FIELD_ORDER_REFORMAT/in0/schema.json',
            'test/resources/data/sap_md_matl_loc_fsn_geu_bba_atl/graph/SET_FIELD_ORDER_REFORMAT/in0/data/test_unit_test_0.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_loc_fsn_geu_bba_atl/graph/SET_FIELD_ORDER_REFORMAT/out/schema.json',
            'test/resources/data/sap_md_matl_loc_fsn_geu_bba_atl/graph/SET_FIELD_ORDER_REFORMAT/out/data/test_unit_test_0.json',
            'out'
        )
    ...
    def test_unit_test_1(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_loc_fsn_geu_bba_atl/graph/SET_FIELD_ORDER_REFORMAT/in0/schema.json',
            'test/resources/data/sap_md_matl_loc_fsn_geu_bba_atl/graph/SET_FIELD_ORDER_REFORMAT/in0/data/test_unit_test_1.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_md_matl_loc_fsn_geu_bba_atl/graph/SET_FIELD_ORDER_REFORMAT/out/schema.json',
            'test/resources/data/sap_md_matl_loc_fsn_geu_bba_atl/graph/SET_FIELD_ORDER_REFORMAT/out/data/test_unit_test_1.json',
            'out'
        )
        dfOutComputed = SET_FIELD_ORDER_REFORMAT(self.spark, dfIn0)
