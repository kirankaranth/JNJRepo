...
from sap_md_matl_loc_fsn_geu_bba_atl.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/SAP_MD_MATL_LOC_FSN_GEU_BBA_ATL")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/SAP_MD_MATL_LOC_FSN_GEU_BBA_ATL")
    pipeline(spark)
