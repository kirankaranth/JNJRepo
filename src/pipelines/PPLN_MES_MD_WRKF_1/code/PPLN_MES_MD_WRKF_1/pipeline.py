...
from PPLN_MES_MD_WRKF_1.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/PPLN_MES_MD_WRKF_1")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/PPLN_MES_MD_WRKF_1")
    pipeline(spark)
