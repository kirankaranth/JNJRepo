...
from sap_01_md_sls_ordr_bwi.graph.NEW_FIELDS_TRANSFORMATION_1 import *
...
class NEW_FIELDS_TRANSFORMATION_1Test(BaseTestCase):
    ...
    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_bwi/graph/NEW_FIELDS_TRANSFORMATION_1/in0/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_bwi/graph/NEW_FIELDS_TRANSFORMATION_1/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_sls_ordr_bwi/graph/NEW_FIELDS_TRANSFORMATION_1/out/schema.json',
            'test/resources/data/sap_01_md_sls_ordr_bwi/graph/NEW_FIELDS_TRANSFORMATION_1/out/data/test_unit_test_.json',
            'out'
        )
