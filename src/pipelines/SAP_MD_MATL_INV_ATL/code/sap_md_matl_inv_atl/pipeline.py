...
def pipeline(spark: SparkSession) -> None:
    ...
    df_Source_1_5 = Source_1_5(spark)
    df_Source_1_1 = Source_1_1(spark)
    df_MANDT_4 = MANDT_4(spark, df_Source_1_1)
    df_MANDT_2 = MANDT_2(spark, df_Source_1_5)
    ...
    df_Source_1_4 = Source_1_4(spark)
    df_MANDT_3 = MANDT_3(spark, df_Source_1_4)
    ...
    df_Source_1_3 = Source_1_3(spark)
    df_MANDT_5 = MANDT_5(spark, df_Source_1_3)
