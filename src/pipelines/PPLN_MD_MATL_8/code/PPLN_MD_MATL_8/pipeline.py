...
from PPLN_MD_MATL_8.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/PPLN_MD_MATL_8")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/PPLN_MD_MATL_8")
    pipeline(spark)
