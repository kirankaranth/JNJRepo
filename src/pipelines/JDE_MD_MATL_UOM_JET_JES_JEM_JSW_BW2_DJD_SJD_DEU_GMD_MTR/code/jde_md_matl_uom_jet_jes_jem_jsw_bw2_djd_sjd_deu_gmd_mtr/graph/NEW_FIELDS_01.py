...
def NEW_FIELDS_01(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0\
        ...
        .withColumn("EXTRNL_UOM_COMML_FMT", LU_T006A_MSEH3(col("MSEHI")).getField("MSEH3"))\
        .withColumn("EXTRNL_UOM_TECH_FMT", LU_T006A_MSEH6(col("MSEHI")).getField("MSEH6"))\
        .withColumn("UOM_SHRT_TEXT", LU_T006A_MSEHT(col("MSEHI")).getField("MSEHT"))\
        .withColumn("UOM_LONG_TEXT", LU_T006A_MSEHL(col("MSEHI")).getField("MSEHL"))\
        .withColumn("DIM_TEXT", LU_T006T_TXDIM(col("DIMID")).getField("TXDIM"))\
