...
from sap_md_matl_inv_bba_bbl_bbn_geu_mrs_mbp.graph import *

def pipeline(spark: SparkSession) -> None:
    df_DS_SAP_06_MARA = DS_SAP_06_MARA(spark)
    df_MANDT_7 = MANDT_7(spark, df_DS_SAP_06_MARA)
    Lookup_1_MARA(spark, df_MANDT_7)
    ...
    df_MANDT_5 = MANDT_5(spark, df_DS_SAP_04_MSLB)
    df_DS_SAP_01_MARD = DS_SAP_01_MARD(spark)
    df_MANDT_6 = MANDT_6(spark, df_DS_SAP_05_MSSL)
