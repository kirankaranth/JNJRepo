...
from MD_SLS_ORDR_SCHED_LINE_DELV_7.config.ConfigStore import *
from MD_SLS_ORDR_SCHED_LINE_DELV_7.udfs.UDFs import *
...
AND VBAK._deleted_ = 'F' AND VBAK.MANDT = \"050\"
LEFT JOIN {Config.sourceDatabase}.TVLST TVLST
ON VBEP.LIFSP = TVLST.LIFSP
AND TVLST._deleted_ = 'F' AND TVLST.MANDT = \"050\" AND TVLST.SPRAS = 'E'
where VBEP._deleted_ = 'F' AND VBEP.MANDT =\"050\"  
