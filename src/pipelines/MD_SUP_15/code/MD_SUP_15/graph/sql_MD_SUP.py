...
from MD_SUP_15.config.ConfigStore import *
from MD_SUP_15.udfs.UDFs import *
...
def sql_MD_SUP(spark: SparkSession) -> DataFrame:
    ...
    SELECT
        ...
        CASE
            WHEN LOWER(TRIM(f0401_adt.a6upmj)) = 'CAST(NULL AS STRING)' OR TRIM(f0401_adt.a6upmj) = '' OR TRIM(f0401_adt.a6upmj) = '0' THEN CAST(NULL AS STRING)
