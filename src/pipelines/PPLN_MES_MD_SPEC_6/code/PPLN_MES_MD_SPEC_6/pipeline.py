...
from PPLN_MES_MD_SPEC_6.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/PPLN_MES_MD_SPEC_6")
    
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/PPLN_MES_MD_SPEC_6")
    pipeline(spark)
