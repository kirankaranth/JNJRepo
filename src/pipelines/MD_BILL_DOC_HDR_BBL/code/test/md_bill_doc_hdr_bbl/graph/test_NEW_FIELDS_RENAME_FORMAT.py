...
class NEW_FIELDS_RENAME_FORMATTest(BaseTestCase):
    ...
    def test_unit_test_(self):
        dfIn0 = createDfFromResourceFiles(
            ...
            'test/resources/data/md_bill_doc_hdr_bbl/graph/NEW_FIELDS_RENAME_FORMAT/in0/data/test_unit_test_.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/md_bill_doc_hdr_bbl/graph/NEW_FIELDS_RENAME_FORMAT/out/schema.json',
            'test/resources/data/md_bill_doc_hdr_bbl/graph/NEW_FIELDS_RENAME_FORMAT/out/data/test_unit_test_.json',
            'out'
        )
