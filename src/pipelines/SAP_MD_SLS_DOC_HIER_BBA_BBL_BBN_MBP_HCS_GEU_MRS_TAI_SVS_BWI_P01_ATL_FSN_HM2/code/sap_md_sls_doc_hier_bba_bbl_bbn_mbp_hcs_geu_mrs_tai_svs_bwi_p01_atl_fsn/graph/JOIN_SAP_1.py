...
def JOIN_SAP_1(spark: SparkSession, in0: DataFrame, in1: DataFrame, ) -> DataFrame:
    return in0\
        .alias("in0")\
        .join(in1.alias("in1"), ((col("in0.`VBAK.VBELN`") == col("in1.`VBAP.VBELN`")) & (col("in0.POSNV") == col("in1.POSNR"))), "left_outer")
