...
from MD_SUP_14.config.ConfigStore import *
from MD_SUP_14.udfs.UDFs import *
...
def sql_MD_SUP(spark: SparkSession) -> DataFrame:
    ...
    with cte as (
    SELECT
        ROW_NUMBER() OVER (partition by f0401.a6an8 ORDER BY f0116.aleftb desc) row,
    ...
    LEFT JOIN {Config.sourceDatabase}.f0116 f0116 on f0401.a6an8=f0116.alan8 AND f0116._deleted_ = 'F'
