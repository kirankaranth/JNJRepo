...
case when VBEP.HANDOVERDATE = '00000000' THEN CAST(NULL AS TIMESTAMP) ELSE to_timestamp(concat(VBEP.HANDOVERDATE,VBEP.HANDOVERTIME),'yyyyMMddHHmmss) as HAND_OVR_LOC_DTTM,
