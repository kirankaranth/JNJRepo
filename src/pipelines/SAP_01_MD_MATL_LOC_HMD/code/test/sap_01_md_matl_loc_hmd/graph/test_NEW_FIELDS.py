...
class NEW_FIELDSTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        dfgraph_LU_SAP_T460A = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/sap_01_md_matl_loc_hmd/graph/LU_SAP_T460A/schema.json',
            'test/resources/data/sap_01_md_matl_loc_hmd/graph/LU_SAP_T460A/data.json',
            "in0"
        )
        from sap_01_md_matl_loc_hmd.graph.LU_SAP_T460A import LU_SAP_T460A
