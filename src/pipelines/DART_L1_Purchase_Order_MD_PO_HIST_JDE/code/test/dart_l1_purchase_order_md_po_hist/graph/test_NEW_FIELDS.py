...
class NEW_FIELDSTest(BaseTestCase):
    ...
    def test_unit_test_(self):
        ...
        assertDFEquals(
            dfOut.select("OLDOCO", "OLLNID", "OLCORD", "OLDCTO", "OLKCOO", "OLLT", "OLSFXO", "OLUPMJ", "OLTDAY"),
            dfOutComputed.select("OLDOCO", "OLLNID", "OLCORD", "OLDCTO", "OLKCOO", "OLLT", "OLSFXO", "OLUPMJ", "OLTDAY"),
